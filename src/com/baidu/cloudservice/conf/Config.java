...
public class Config{
	...
	public static String USER = "bAXnXlwe9qSrbLpWxejcQxZZ";
	public static String PWD = "Ns8NEAGCs6NasRhgx3dV0D5ZesL4apsS";

  	/***MySQL相关配置***/
	public static String MYSQLNAME = "dhThMCAtExAgFJYMfwaO";
